        ...
        <v-list dense nav shaped>
          <v-list-item-group>
            ...
            <router-link tag="v-list-item" to="/admin/orders" active-class="active-link">
              ...
              <v-list-item-title>
                Orders <v-chip x-small color="grey" class="ml-4 mb-1 white--text">{{ orderCount }}</v-chip>
              </v-list-item-title>
            </router-link>
            ...
            <router-link tag="v-list-item" to="/admin/reps" active-class="active-link">
              ...
              <v-list-item-title>Sales Representives</v-list-item-title>
            </router-link>

            <v-list-group prepend-icon="mdi-tune-variant" :value="isB2BGroupOpen" no-action>
              <template v-slot:activator>
                <v-list-item-title>B2B Hub</v-list-item-title>
              </template>
              ...
              <router-link tag="v-list-item" to="/admin/custom-price" active-class="active-link">
                ...
                <v-list-item-title>Custom Prices</v-list-item-title>
              </router-link>
            </v-list-group>
            ...
            <v-list-group prepend-icon="mdi-palette-swatch-variant" :value="isThemeGroupOpen" no-action>
              ...
              <router-link tag="v-list-item" to="/admin/slider-headers" active-class="active-link">
                ...
                <v-list-item-title>Header Setting</v-list-item-title>
              </router-link>
              ...
              <router-link tag="v-list-item" to="/admin/round-sliders" active-class="active-link">
                ...
                <v-list-item-title>Round Sliders</v-list-item-title>
              </router-link>
              ...
              <router-link tag="v-list-item" to="/admin/fruit-sliders" active-class="active-link">
                ...
                <v-list-item-title>Featured Sliders</v-list-item-title>
              </router-link>
              ...
              <router-link tag="v-list-item" to="/admin/loyalty-reward-banner" active-class="active-link">
                ...
                <v-list-item-title>Rewards Banner</v-list-item-title>
              </router-link>
            ...
            <v-list-group prepend-icon="mdi-store-cog-outline" :value="isShopGroupOpen" no-action>
              ...
              <router-link tag="v-list-item" to="/admin/delivery-method" active-class="active-link">
                ...
                <v-list-item-title>Delivery Setting</v-list-item-title>
              </router-link>
              ...
              <router-link tag="v-list-item" to="/admin/shipping-integration" active-class="active-link">
                ...
                <v-list-item-title>Shipping Integration</v-list-item-title>
              </router-link>
              ...
              <router-link tag="v-list-item" to="/admin/payment-method" active-class="active-link">
                ...
                <v-list-item-title>Payment Setting</v-list-item-title>
              </router-link>
              ...
              <router-link tag="v-list-item" to="/admin/services" active-class="active-link">
                ...
                <v-list-item-title>Other Display</v-list-item-title>
              </router-link>
...
export default {
  ...
  computed: {
    isB2BGroupOpen() {
      return this.$route.path.startsWith('/admin/customer-tags')
    ...
    isThemeGroupOpen() {
      return this.$route.path.startsWith('/admin/slider-headers')
        || this.$route.path.startsWith('/admin/round-sliders')
