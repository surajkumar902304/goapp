    ...
    <v-dialog v-model="bulkAddDialog" max-width="500">
      <v-card elevation="5">
        ...
        <v-card-actions>
          ...
          <v-btn class="btn-32-text-12" text color="red" :loading="bulkAddLoading" :disabled="bulkAddLoading || !bulk_product_tag" @click="performBulkAdd">Add</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
    ...
    <v-dialog v-model="bulkRemoveDialog" max-width="500">
      <v-card elevation="5">
        ...
        <v-card-actions>
            ...
            <v-btn class="btn-32-text-12" text color="red" :loading="bulkRemoveLoading" :disabled="bulkRemoveLoading" @click="performBulkRemove">Remove</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </div>
