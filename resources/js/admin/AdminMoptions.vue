<template>
    <div>
        <v-row>
            <v-col cols="12" md="6">
                <h2 class="text-h6 fw-semibold">Options</h2>
            </v-col>
        ...
        <v-row>
            <v-col cols="12" md="12">
                <v-card outlined>
                    <v-data-table :items="moptions" :headers="moptionHeaders">
...
export default {
    ...
    data(){
        return{
            ...
            moptions:[],
            moptionHeaders:[
                {text:'Option ID',value:'moption_id'},
                {text:'Option Name',value:'moption_name'},
