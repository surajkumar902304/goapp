...
export default {
    ...
    data () {
        return {
            ...
            selectedTags: [],
            mprosHeaders: [
                { text: '', value: 'mproduct_image', class: 'grey lighten-3', width: '100px', sortable: false },
                { text: 'Product', value: 'mproduct_title', class: 'grey lighten-3', width: '40%'},
                { text: 'Status', value: 'status', class: 'grey lighten-3', width: '100px' },
                { text: 'Inventory', value: 'minventory', class: 'grey lighten-3' },
