                        ...
                        <v-card-text>
                            <v-row>
                                <v-col cols="12" md="12">
                                    ...
                                    <v-checkbox v-model="pro.selectedSalesChannel" label="Online Store" value="Online Store" @change="handleCheckboxChange('Online Store')"></v-checkbox>
                                    <v-checkbox v-model="pro.selectedSalesChannel" label="Other" value="Other" @change="handleCheckboxChange('Other')"></v-checkbox>
                                </v-col>
                            </v-row>
                        </v-card-text>
                    </v-card>
    ...
    methods: {
        getProductData() {
            ...
            .then((resp) => {
                ...
                console.log("Fetched product data:", resp.data);
            })
            .catch((error) => {
        ...
        handleCheckboxChange(selectedValue) {
                this.selectedSalesChannel = selectedValue;
        },       
        triggerFileInput() {
