  ...
  <div style="margin: 20px 60px !important;" class="page-sub-cat-add">
    ...
    <v-row class="mt-0">
      ...
      <v-col cols="6" class="text-end">
        <v-btn style="color: #1976d2; background-color: white !important; border: 1px solid #1976d2 !important;" small outlined @click="discard" class="mr-2 btn-32-text-12">Discard</v-btn>
        <v-btn small style="color: #1976d2; background-color: white !important; border: 1px solid #1976d2 !important;" :loading="saveLoading" :disabled="saveDisabled" @click="saveSubCategory" class="btn-32-text-12">
          <template v-slot:loader>
                <v-progress-circular indeterminate size="20" color="white"></v-progress-circular>
            </template>
      ...
      <v-col cols="12" md="9">
          ...
          <v-card-text>
            <v-radio-group v-model="mcattype" class="mt-1" hide-details>
              <div class="d-flex align-center" style="margin-bottom: 8px;">
                <v-radio value="manual" hide-details class="pa-0" style="margin: 0; padding-right: 4px;" density="compact"></v-radio>
                <span style="font-size: 13px; margin-top: 1px;">Manual</span>
              </div>
              <div class="d-flex align-center">
                <v-radio value="smart" hide-details class="pa-0" style="margin: 0; padding-right: 4px;" density="compact"></v-radio>
        ...
        <v-card v-if="mcattype==='manual'" elevation="5" class="my-3">
          ...
          <v-card-text>
            <v-row>
              <v-col cols="6">
                <v-text-field dense hide-details outlined prepend-inner-icon="mdi-magnify mb-2" v-model="productSearch" placeholder="Search Product"/>
              </v-col>
              <v-col cols="2">
                <v-btn style="color: #1976d2; background-color: white !important; border: 1px solid #1976d2 !important;" dense outlined @click="productDialog=true" class="btn-32-text-12 mt-1">Browse</v-btn>
              </v-col>
              <v-col cols="4">
            ...
            <div v-if="selectedProducts.length" class="px-4 pb-4">
              ...
              <v-list dense>
                <v-list-item v-for="p in selectedProducts" :key="p.mproduct_id">
                  ...
                  <v-list-item-action>
                    <v-btn class="btn-32-text-12" icon @click="removeProduct(p.mproduct_id)"><v-icon>mdi-close</v-icon></v-btn>
                  </v-list-item-action>
                </v-list-item>
              </v-list>
            </div>
        ...
        <v-card v-else elevation="5" class="my-3">
          ...
          <v-card-text>
            <div class="d-flex align-center" style="gap: 8px; font-size: 12px;">
              ...
              <v-radio-group v-model="acondition" row hide-details class="d-flex align-center ml-2" style="margin-bottom: 10px !important; margin-top: 10px !important;">
                <div class="d-flex align-center" style="margin-left: 8px;">
                  <v-radio value="all" hide-details class="pa-0" style="margin: 0; padding-right: 4px;" density="compact"></v-radio>
                  <span style="font-size: 12px;">All conditions</span>
                </div>

                <div class="d-flex align-center" style="margin-left: 12px;">
                  <v-radio value="any" hide-details class="pa-0" style="margin: 0; padding-right: 4px;" density="compact"></v-radio>
            ...
            <v-btn style="color: #1976d2; background-color: white !important; border: 1px solid #1976d2 !important;" class="btn-32-text-12" outlined small @click="addCondition"><v-icon small>mdi-plus</v-icon> Add another condition</v-btn>
          </v-card-text>
        </v-card>
      </v-col>
            ...
            <v-row>
                <v-col cols="12" md="12">
                    ...
                    <div class="d-flex align-center" style="margin-top: 4px;">
                        <v-checkbox v-model="msubcat_publish" value="Other" hide-details class="pa-0" style="margin: 0; padding-right: 4px;" 
        ...
        <v-card elevation="5">
          ...
          <v-card-text>
            ...
            <div v-else class="d-flex align-center">
              ...
              <v-btn class="btn-32-text-12 ml-2" icon small @click="clearImage"><v-icon color="red">mdi-trash-can</v-icon></v-btn>
            </div>
          </v-card-text>
        </v-card>
