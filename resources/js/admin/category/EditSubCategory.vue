    ...
    <v-row>
      <v-col cols="12" md="9">
        ...
        <v-card v-else elevation="5" class="my-3">
          <v-card-subtitle style="padding-bottom: 0px !important;">Conditions</v-card-subtitle>
          <v-card-text>
        ...
        <v-card v-if="mcattype==='smart'" class="my-5" elevation="5">
        ...
        <v-card elevation="5">
          ...
          <v-card-text>
            ...
            <div v-else class="d-flex align-center">
              ...
              <v-btn class="btn-32-text-12 ml-2" icon small @click="clearImage">
                <v-icon color="red">mdi-trash-can</v-icon>
              </v-btn>
            </div>
          </v-card-text>
