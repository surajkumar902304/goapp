...
class CreateHomeRoundBannersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('home_round_banners', function (Blueprint $table) {
            $table->id('home_round_banner_id');
            $table->string('home_round_banner_name');
            $table->string('home_round_banner_image');
            $table->integer('home_round_banner_position')->default(0);
    ...
    {
        Schema::dropIfExists('home_round_banners');
    }
}
