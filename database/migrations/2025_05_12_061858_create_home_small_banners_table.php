...
class CreateHomeSmallBannersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('home_small_banners', function (Blueprint $table) {
            $table->id('home_small_banner_id');
            $table->string('home_small_banner_name');
            $table->string('home_small_banner_image');
            $table->integer('home_small_banner_position')->default(0);
    ...
    {
        Schema::dropIfExists('home_small_banners');
    }
}
