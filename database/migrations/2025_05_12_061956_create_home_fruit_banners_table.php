...
class CreateHomeFruitBannersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('home_fruit_banners', function (Blueprint $table) {
            $table->id('home_fruit_banner_id');
            $table->string('home_fruit_banner_name');
            $table->string('home_fruit_banner_image');
            $table->integer('home_fruit_banner_position')->default(0);
    ...
    {
        Schema::dropIfExists('home_fruit_banners');
    }
}
