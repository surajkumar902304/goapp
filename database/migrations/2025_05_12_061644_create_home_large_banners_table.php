...
class CreateHomeLargeBannersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('home_large_banners', function (Blueprint $table) {
            $table->id('home_large_banner_id');
            $table->string('home_large_banner_name');
            $table->string('home_large_banner_image');
            $table->integer('home_large_banner_position')->default(0);
    ...
    {
        Schema::dropIfExists('home_large_banners');
    }
}
